  ...
  return (
    <section id="modes" className="mx-auto max-w-[1320px] scroll-mt-24 px-4 py-14 sm:py-20 sm:px-6 lg:px-10">
      ...
      <div className="grid items-stretch gap-6 sm:gap-8 lg:grid-cols-3">
        ...
        <div className="glass-card relative flex flex-col justify-between rounded-3xl sm:rounded-[2rem] border border-indigo-500/30 bg-gradient-to-b from-indigo-50/25 via-white to-white p-6 sm:p-8 shadow-xl transition-all duration-300 hover:border-indigo-500 hover:shadow-2xl group">
          ...
          <div>
            <div className="mb-6 mt-2 flex items-center justify-between">
              ...
              <span className="flex items-center gap-1.5 rounded-full border border-indigo-200 bg-indigo-50 px-3 py-1 font-mono text-[10px] font-extrabold uppercase text-indigo-800">
                <span className="h-1.5 w-1.5 rounded-full bg-indigo-500"></span> DEFAULT ACTIVE
              </span>
            </div>
